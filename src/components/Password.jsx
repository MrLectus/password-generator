        ...
        <div className='flex flex-col p-2 text-white'>
            ...
            <div className='bg-neutral-800 p-4 rounded-sm mt-4 drop-shadow-md'>
                ...
                <div className='flex flex-col'>
                    <label className='tracking-widest text-xs flex items-center cursor-pointer' htmlFor='upper' > <input className='outline-none border-none w-5 h-5 cursor-pointer' onChange={() => setUpper((prevUpper) => !prevUpper)} type="checkbox" id="upper" name="" value={upper} />&emsp;Include Uppercase Letters</label><br />
                    <label className='tracking-widest text-xs flex items-center cursor-pointer' htmlFor='lower' > <input className='outline-none border-none w-5 h-5 cursor-pointer' onChange={() => setLower((prevUpper) => !prevUpper)} type="checkbox" id="lower" name="" value={lower} />&emsp;Include Lowercase Letters</label><br />
                    <label className='tracking-widest text-xs flex items-center cursor-pointer' htmlFor='number' > <input className='outline-none border-none w-5 h-5 cursor-pointer' onChange={() => setNumber((prevUpper) => !prevUpper)} type="checkbox" id="number" name="" value={number} />&emsp;Include Numbers</label><br />
                    <label className='tracking-widest text-xs flex items-center cursor-pointer' htmlFor='symbol' > <input className='outline-none border-none w-5 h-5 cursor-pointer' onChange={() => setSymbol((prevUpper) => !prevUpper)} type="checkbox" id="symbol" name="" value={symbol} />&emsp;Include Symbols</label><br />
                </div>
